#!/usr/bin/env python3
"""
Golden Rules -- universal code health checks for x-teamcode projects.

Pre-installed by x-teamcode skill. Copied to <project>/scripts/ during
Phase B (Plan-to-Team Bridge). Called by run_ci.py as part of the CI pipeline.

Usage:
    # Standalone
    python golden_rules.py <src_dir1> [src_dir2] ... [--docs <docs_dir>]
